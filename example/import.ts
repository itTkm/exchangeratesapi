...
async function exchangeratesapiSamples() {
   ...
   *  - Symbols: GBP, JPY, EUR
   */
  const latestParameters: IExchangeratesapiParams = {
    base: "USD",
    symbols: ["GBP", "JPY", "EUR"],
  };
   ...
   *  - Symbols: GBP, JPY, EUR
   */
  const historicalParameters: IExchangeratesapiParams = {
    date: "2013-12-24",
    base: "GBP",
    symbols: ["USD", "CAD", "EUR"],
  };
   ...
   *  - Date: 2018-02-22
   */
  const convertParameters: IExchangeratesapiConvertParams = {
    from: "GBP",
    to: "JPY",
    amount: 25,
    date: "2018-02-22",
   ...
   *  - Symbols: USD, AUD, CAD
   */
  const timeseriesParameters: IExchangeratesapiTimeseriesParams = {
    start_date: "2012-05-01",
    end_date: "2012-05-03",
    base: "EUR",
    symbols: ["USD", "AUD", "CAD"],
